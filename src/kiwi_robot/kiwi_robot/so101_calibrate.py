...
and joint ranges of motion. Run this once for each arm (puppeteer and puppet).
"""
...
class SO101CalibrateNode(Node):
    ...
    def __init__(self):
        ...
        if not output_file:
            output_file = f'{self.arm_id}_calibration.json'
    ...
    def run_calibration(self):
        ...
        if not sys.stdin.isatty():
            ...
            print(f'    ros2 run kiwi_robot so101_calibrate --ros-args \\')
        ...
        print('  You can now use this calibration file with your puppeteer/puppet nodes.\n')
